...
tiktoken_cache_dir = get_project_base_directory('static/tiktoken_cache').replace('\\','/')
if not os.path.exists(tiktoken_cache_dir):
    raise Exception(f"tiktoken缓存位置{tiktoken_cache_dir}不存在")
#print(f'tiktoken缓存位置{tiktoken_cache_dir}')
