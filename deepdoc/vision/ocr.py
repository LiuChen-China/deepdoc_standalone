...
import os
try:
    from common.settings import USE_CUDA
    from common.file_utils import get_project_base_directory
    from common import settings
    from .operators import *  # noqa: F403
    from . import operators
except:
    from deepdoc_standalone.common.settings import USE_CUDA
    ...
    from deepdoc_standalone.deepdoc.vision.operators import *  # noqa: F403
    from deepdoc_standalone.deepdoc.vision import operators    
import math
import numpy as np
import cv2
...
def cuda_is_available(device_id: int = 0):
    try:
        import torch
