...
try:
    ...
    from deepdoc_standalone.rag.nlp import tokenize, is_english
    from deepdoc_standalone.rag.nlp import rag_tokenizer
    from deepdoc_standalone.deepdoc.parser import PdfParser, PptParser, PlainParser
    from deepdoc_standalone.rag.app.naive import PARSERS    
...
if __name__ == "__main__":
    ...
    def dummy(prog=None, msg=""):
        pass
    path = os.path.join(get_project_base_directory(), "static/测试文件/test.pptx")
    result = chunk(path, callback=dummy)
    pass
